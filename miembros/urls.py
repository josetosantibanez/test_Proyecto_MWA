...
from . import views
from .views import MiembroListView,MiembroDetailView,MiembroUpdateView,MiembroDeleteView,agregar_miembro,solicitudes

miembros_patterns = ([
    path('', MiembroListView.as_view(), name='miembros'),
    path('solicitudes_ingreso',solicitudes,name='solicitudes'),
